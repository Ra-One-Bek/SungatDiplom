        ...
        <div className="grid grid-cols-1 xl:grid-cols-2">
          <div className="p-8 md:p-10">
            ...
            <h3 className="mt-4 text-3xl font-black text-slate-900">
              Почему эта страница важна для диплома
            </h3>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              About-страница показывает, что проект — это не просто набор таблиц
              и графиков, а полноценная продуктовая система с брендингом,
              персонализацией, визуальной айдентикой и понятным пользовательским
              опытом.
            </p>
          </div>
          ...
          >
            <div className="max-w-md text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-white/90">
                Эта часть проекта усиливает восприятие продукта и делает систему
                визуально цельной для тренера, аналитика и администратора.
              </p>
            </div>
          </div>
        </div>
